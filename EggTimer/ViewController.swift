...
//  EggTimer
//
//  Created by Maksim on 28.05.2024.
//
...
class ViewController: UIViewController {
    ...
    @objc private func eggsButtonsTaped(_ sender: UIButton) {
        timer.invalidate()
...
// MARK: - Set Views and Set Constrains
...
extension ViewController {
    private func setViews() {
        ...
        softButton.addTarget(self, action: #selector(eggsButtonsTaped), for: .touchUpInside)
        mediumButton.addTarget(self, action: #selector(eggsButtonsTaped), for: .touchUpInside)
        hardButton.addTarget(self, action: #selector(eggsButtonsTaped), for: .touchUpInside)
    ...
    private func setupConstrains() {
        NSLayoutConstraint.activate([
            ...
            softButton.leftAnchor.constraint(equalTo: softImageView.leftAnchor),
            ...
            mediumButton.leftAnchor.constraint(equalTo: mediumImageView.leftAnchor),
            ...
            hardButton.leftAnchor.constraint(equalTo: hardImageView.leftAnchor),
